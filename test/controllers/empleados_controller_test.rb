...
class EmpleadosControllerTest < ActionDispatch::IntegrationTest
  setup do
    @empleado = FactoryBot.create(:empleado)
  end
  ...
  test "should create empleado" do
    assert_difference("Empleado.count") do
      post empleados_url, params: { empleado: { apellido: @empleado.apellido, cuit: @empleado.cuit, nombre: @empleado.nombre } }
    end
  ...
  test "should update empleado" do
    patch empleado_url(@empleado), params: { empleado: { apellido: @empleado.apellido, cuit: @empleado.cuit, nombre: @empleado.nombre } }
