...
class ServiciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create servicio" do
    assert_difference("Servicio.count") do
      post servicios_url, params: { servicio: { comentarios: @servicio.comentarios, empresa_id: @servicio.empresa_id, fin: @servicio.fin, inicio: @servicio.inicio, precio: @servicio.precio } }
    end
  ...
  test "should update servicio" do
    patch servicio_url(@servicio), params: { servicio: { comentarios: @servicio.comentarios, empresa_id: @servicio.empresa_id, fin: @servicio.fin, inicio: @servicio.inicio, precio: @servicio.precio } }
