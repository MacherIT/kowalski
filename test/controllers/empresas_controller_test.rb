...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference("Empresa.count") do
      post empresas_url, params: { empresa: { cuit_0: @empresa.cuit_0, cuit_1: @empresa.cuit_1, cuit_2: @empresa.cuit_2, nombre: @empresa.nombre } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { cuit_0: @empresa.cuit_0, cuit_1: @empresa.cuit_1, cuit_2: @empresa.cuit_2, nombre: @empresa.nombre } }
